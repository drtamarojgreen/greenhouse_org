...
ALTER TABLE public.user_passwords ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.user_passwords_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mfa_secrets; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: mfa_secrets_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.mfa_secrets ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.mfa_secrets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mfa_secrets mfa_secrets_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: mfa_secrets mfa_secrets_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE user_passwords; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.user_passwords TO wellness_app;
GRANT SELECT ON TABLE public.user_passwords TO wellness_readonly;

--
-- Name: TABLE mfa_secrets; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.mfa_secrets TO wellness_app;
GRANT SELECT ON TABLE public.mfa_secrets TO wellness_readonly;

--
-- Name: TABLE token_blacklist; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.token_blacklist TO wellness_app;
GRANT SELECT ON TABLE public.token_blacklist TO wellness_readonly;
