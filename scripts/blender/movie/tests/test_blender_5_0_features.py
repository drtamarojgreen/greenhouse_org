...
class TestBlender50Features(unittest.TestCase):
    ...
    def test_1_3_1_color_ramp_clear_logic(self):
        ...
        ramp = next((n for n in mat.node_tree.nodes if n.type == 'VAL_TO_RGB' or 'VAL_TO_RGB' in n.bl_idname), None)
        self.assertIsNotNone(ramp, "ColorRamp node not found in noise material")
