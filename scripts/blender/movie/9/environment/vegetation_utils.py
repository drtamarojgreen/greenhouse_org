...
def apply_mat(obj, name, color, emission=0.0, alpha=False, metallic=0.0, roughness=0.5):
    """
    Utility to create and apply Principled BSDF materials.
    Architecture Kept: Centralized material utilities ensure visual consistency
    across all procedurally generated flora in the mental frontier.
    """
