...
class MovieConfig:
    ...
    @property
    def output_dir(self):
        path = self.get("paths.output_dir", "scripts/blender/movie/9/assets/")
        return path

    @property
    def coll_assets(self):
        return self.get("collections.assets", "9a.ASSETS")

    @property
    def coll_environment(self):
        return self.get("collections.environment", "9b.ENVIRONMENT")
