...
class PlantRigger(Rigger):
    ...
    Architecture Kept: The bone hierarchy from Movie 9 is retained to support
    the complex deformation of organic plant structures, while allowing for the
    'lifelike' animation upgrades in Movie 9.
    """
