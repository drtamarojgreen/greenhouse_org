...
class AssetManager:
    ...
    Architecture Kept: The centralized asset management from Movie 9 is kept in Movie 9
    to handle the complex tasks of clearing scenes, linking assets, and performing
    geometric normalization in a consistent, reproducible way.
    """
    ...
    def link_assets(self, blend_path, targets):
        ...
        Feature Kept: The deduplicated linking logic prevents Blender instability
        when multiple components request the same ID, ensuring a robust production pipeline.
        """
    ...
    def normalize_character(self, rig, target_height):
        ...
        Feature Kept: Geometric normalization (scaling and origin resets) is critical
        for maintaining visual consistency across diverse procedurally generated entities.
        """
