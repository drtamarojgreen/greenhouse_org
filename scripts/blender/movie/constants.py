...
# Separate aliases to avoid breaking contiguity tests if they only iterate keys
SCENE_ALIASES = {
    'interaction': (4501, 9500),
    'scene22': (13701, 14500),
    'scene10_lab': (2801, 3300),
...
# Quality Presets
QUALITY_PRESETS = {
    'test': {'samples': 64, 'denoising': True},
    'preview': {'samples': 128, 'denoising': True},
    'final': {'samples': 256, 'denoising': True}
}
