...
(Point 92)
Refactored to import common functions from style_utilities.
"""
import bpy
import random
import math
...
from .style_utilities import (
    ...
    get_mix_output, get_principled_socket, set_principled_socket,
    patch_fbx_importer, get_socket_by_identifier, set_socket_value,
    clear_scene_selective, create_noise_based_material, apply_scene_grade,
    animate_foliage_wind, animate_light_flicker, insert_looping_noise,
    animate_breathing, animate_dust_particles, apply_fade_transition,
    camera_push_in, camera_pull_out, apply_camera_shake, ease_action,
    animate_blink, animate_saccadic_movement, animate_finger_tapping,
    apply_reactive_foliage, animate_leaf_twitches, animate_pulsing_emission,
    animate_dynamic_pupils, apply_thought_motes, animate_gait,
    animate_cloak_sway, animate_shoulder_shrug, animate_gnome_stumble,
    apply_reactive_bloom, apply_thermal_transition, setup_chromatic_aberration,
    setup_god_rays, animate_vignette, apply_neuron_color_coding,
    setup_bioluminescent_flora, animate_mood_fog, apply_film_flicker,
    apply_glow_trails, setup_saturation_control, apply_desaturation_beat,
    ...
    animate_floating_spores, FCurveProxy, ensure_material_node_tree,
    ensure_compositor_tree, ensure_world_node_tree
)
...
__all__ = [
    ...
    'apply_interior_exterior_contrast', 'replace_with_soft_boxes',
    'animate_hdri_rotation', 'apply_iris_wipe', 'animate_vignette_breathing',
    'animate_floating_spores', 'ensure_material_node_tree',
    'ensure_compositor_tree', 'ensure_world_node_tree'
]
