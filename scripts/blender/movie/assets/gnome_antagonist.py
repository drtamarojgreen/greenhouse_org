...
def create_gnome(name, location, scale=0.6):
    ...
    mat_gloom = bpy.data.materials.new(name=f"{name}_MatGloom"); style.set_principled_socket(mat_gloom, "Emission Color", (0.1, 0, 0.2, 1)); style.set_principled_socket(mat_gloom, "Emission Strength", 0.5)
