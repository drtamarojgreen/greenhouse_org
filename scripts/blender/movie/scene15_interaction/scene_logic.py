...
def setup_scene(master):
    ...
    if master.h1 and master.h1.type == 'ARMATURE':
        staff = master.h1.pose.bones.get("Arm.R") # Staff is parented to Arm.R
    else:
    ...
    # Both characters breathing and subtle movements (Bone-aware)
    ...
    style.animate_breathing(h1_torso, 7501, 9000, amplitude=0.04)
    style.animate_breathing(h2_torso, 7501, 9000, amplitude=0.02)
