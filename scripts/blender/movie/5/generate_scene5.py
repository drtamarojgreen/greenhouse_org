...
def generate_full_scene_v5():
    """Builds the Scene 5 from an absolute scorched-earth clean slate."""
    ...
    bpy.context.view_layer.update()
    print("Scene 5: Production-Ready V5 Assembly Complete [CLEAN SLATE].")
