...
# Ensure scene 5 modules are in path
SCENE5_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
class TestV5Rigging(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_rig_existence(self):
        ...
        self.assertIsNotNone(self.herb, "Herbaceous V5 missing")
        self.assertIsNotNone(self.arbor, "Arbor V5 missing")
