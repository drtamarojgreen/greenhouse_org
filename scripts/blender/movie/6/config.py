...
CHAR_HERBACEOUS_EYE = (-1.75, -0.3, 4.5)
CHAR_ARBOR_EYE      = ( 1.75,  0.3, 4.5)

# 6. BACKDROP POSITIONS
BACKDROP_WIDE_POS = (0.0, 50.0, 5.0)
BACKDROP_OTS1_POS = (-100.0, -80.0, 5.0)
BACKDROP_OTS2_POS = (100.0, 80.0, 5.0)
