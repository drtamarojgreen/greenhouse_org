    ...
    def load_assets(self):
        ...
        if os.path.exists(brain_path):
            ...
            bpy.ops.import_scene.fbx(
                filepath=brain_path,
                directory=os.path.dirname(brain_path),
                files=[{"name": os.path.basename(brain_path)}]
            )
        ...
        if os.path.exists(neuron_path):
            ...
            bpy.ops.import_scene.fbx(
                ...
                directory=os.path.dirname(neuron_path),
                files=[{"name": os.path.basename(neuron_path)}]
            )
            imported = bpy.context.selected_objects
