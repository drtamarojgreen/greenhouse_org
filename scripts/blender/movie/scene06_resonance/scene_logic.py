...
def setup_scene(master):
    ...
    for light_name in ["Sun", "FillLight", "RimLight", "Spot"]:
        ...
        light.data.energy = base_energy * 6.0 # Blinding resonance
    ...
    for char in [master.h1, master.h2]:
        if char:
            ...
            char.rotation_euler[0] = math.radians(-20) # Look up in awe
    ...
    # Greenhouse Pulse (if applicable)
    # We can pulse the Emission of the iron structure
