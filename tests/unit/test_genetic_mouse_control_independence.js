...
TestFramework.describe('Mouse Control Independence - Main Window vs PiP', () => {
    ...
    TestFramework.describe('Event Propagation Tests', () => {
        ...
        TestFramework.it('should allow main controller when clicking outside PiP', () => {
            const mainEvent = {
                clientX: 400, // Center - main view
                clientY: 400,
                button: 0,
    ...
    TestFramework.describe('PiP Position Detection', () => {
        ...
        TestFramework.it('should correctly identify micro PiP (top right)', () => {
        ...
        TestFramework.it('should correctly identify protein PiP (middle right)', () => {
        ...
        TestFramework.it('should correctly identify target PiP (bottom right)', () => {
        ...
        TestFramework.it('should return null for main view area', () => {
        ...
        TestFramework.it('should handle edge cases at PiP boundaries', () => {
    ...
    TestFramework.describe('Camera State Isolation', () => {
        ...
        TestFramework.it('should not affect main camera when modifying PiP camera', () => {
        ...
        TestFramework.it('should not affect other PiP cameras when modifying one', () => {
            const helixCamera = pipControls.cameras.helix;
    ...
    TestFramework.describe('Mouse Event Routing', () => {
        ...
        TestFramework.it('should handle mouse move only for active PiP', () => {
    ...
    TestFramework.describe('Wheel Event Handling', () => {
        ...
        TestFramework.it('should not handle wheel events outside PiP areas', () => {
            const wheelEvent = {
                clientX: 400,
                clientY: 400,
                deltaY: 100,
    ...
    TestFramework.describe('Integration: Full Mouse Interaction Flow', () => {
        ...
        TestFramework.it('should handle complete drag interaction on main without affecting PiP', () => {
            const initialMainRotation = mainCamera.rotationY;
            const initialMicroRotation = pipControls.cameras.micro.rotationY;
    ...
    TestFramework.describe('Potential Issues Diagnosis', () => {
        ...
        TestFramework.it('ISSUE: Verify mousemove event checks activePiP before routing to main', () => {
            // Activate PiP
            const downEvent = {
                clientX: 900,
                clientY: 50,
        ...
        TestFramework.it('ISSUE: Verify wheel event checks PiP position before routing', () => {
            const wheelEvent = {
                clientX: 900,
                clientY: 50,
                deltaY: 100,
