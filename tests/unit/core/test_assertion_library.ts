...
(function () {
    const { assert, AssertionError } = window;
    ...
    TestFramework.describe('Assertion Library', () => {
        ...
        TestFramework.describe('throws / throwsAsync', () => {
            ...
            TestFramework.it('should assert that async function throws an error', () => __awaiter(this, void 0, void 0, function* () {
                yield assert.throwsAsync(() => __awaiter(this, void 0, void 0, function* () { throw new Error('async error'); }));
            }));
            TestFramework.it('should throw if async function does not throw', () => __awaiter(this, void 0, void 0, function* () {
                yield assert.throwsAsync(() => __awaiter(this, void 0, void 0, function* () { return assert.throwsAsync(() => __awaiter(this, void 0, void 0, function* () { })); }), AssertionError);
            }));
        });
