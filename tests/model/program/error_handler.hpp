...
#include "../analyzer/error_wrapper.hpp"
#include "../analyzer/error_types.hpp"
#include "../analyzer/rpc_protocol.hpp"
#include <cstdio>
#include <cstdarg>
#include <mutex>
...
public:
    ...
    void report_ptr(ErrorType type, const void* ptr, const char* file, int line,
                    const char* msg = "") noexcept {
        report<uint64_t>(type, reinterpret_cast<uintptr_t>(ptr), file, line, msg);
    }
