...
### 4.2 Environmental Safety (Dialogue Blocking)
...
## 5. Line-by-Line Analysis of Regressions
| Feature | Version | Intent | V9 Status | Reason for Gap |
| :--- | :--- | :--- | :--- | :--- |
