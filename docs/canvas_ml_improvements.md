...
- **Action:**
  1. Spin up a temporary preview environment.
  2. Run the `tools/canvas_ml/pipeline.py` against the preview URLs.
  3. Compare the scores/clusters against the `main` branch baseline.
  4. Post a comment on the PR with the "Visual Impact Report" (Regression/Improvement).
