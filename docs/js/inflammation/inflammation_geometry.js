    ...
    const GreenhouseInflammationGeometry = {
        initializeBrainShell(brainShell) {
            if (window.GreenhouseBrainMeshRealistic) {
                ...
                brainShell.faces = realisticBrain.faces.map(face => (Object.assign(Object.assign({}, face), { region: null })));
            ...
            for (let lat = 0; lat <= latBands; lat++) {
                ...
                for (let lon = 0; lon <= lonBands; lon++) {
                    ...
                    let brodmann = null;
                    // Region Assignment
                    if (Math.abs(nx) < 0.2 && ny < 0.2 && ny > -0.1 && Math.abs(nz) < 0.2)
                        region = 'thalamus';
                    else if (Math.abs(nx) < 0.18 && ny <= -0.1 && ny > -0.3 && Math.abs(nz) < 0.18)
                        region = 'hypothalamus';
                    else if (Math.abs(nx) > 0.2 && Math.abs(nx) < 0.4 && ny < 0.15 && ny > -0.2 && Math.abs(nz) < 0.3)
                        region = 'basal_ganglia';
                    else if (Math.abs(nx) > 0.45 && ny < 0.1 && ny > -0.3 && nz > -0.1 && nz < 0.25)
                        region = 'insula';
                    else if (Math.abs(nx) > 0.35 && ny < 0.0 && ny > -0.35 && nz < -0.2 && nz > -0.5)
                        region = 'hippocampus';
                    else if (Math.abs(nx) > 0.3 && ny < -0.3 && ny > -0.5 && nz < -0.1 && nz > -0.3)
                        region = 'amygdala';
                    // Lobe Assignment
                    if (nz > 0.3)
                        lobe = 'frontal';
                        ...
                        lobe = 'temporal';
                    else if (Math.abs(nx) < 0.3 && ny < 0.2 && ny > -0.2)
                        lobe = 'insular';
                    // Brodmann Area Assignment (Simplified)
                    if (lobe === 'frontal' && nx > 0.1 && ny > 0.4)
                        brodmann = 'BA9';
                    if (lobe === 'frontal' && Math.abs(nx) < 0.1 && ny < 0.3 && ny > 0.1)
                        brodmann = 'BA24';
        ...
        generateMoleculeCluster(type, scale = 1.0) {
            ...
            if (type === 'pro-cytokine' || type === 'tnf') {
                atom(0, 12, 0, '#E0E0E0', 5);
                atom(0, 4, 0, '#333333', 6);
                atom(-6, -4, 4, '#A0AEC0', 5);
                atom(8, -8, 4, '#333333', 6);
                atom(14, -12, 8, '#E0E0E0', 5);
                atom(-8, -8, 4, '#333333', 6);
                atom(-14, -12, 8, '#E0E0E0', 5);
                atom(0, -2, 8, '#eee', 3);
            }
            else if (type === 'anti-cytokine' || type === 'il10') {
                atom(-10, 0, 0, '#FFFFFF', 6);
                atom(-18, 5, 2, '#A0AEC0', 4);
                atom(-4, -5, -2, '#E0E0E0', 4);
                atom(10, 0, 0, '#FFFFFF', 6);
                atom(18, -5, -2, '#A0AEC0', 4);
                atom(4, 5, 2, '#E0E0E0', 4);
        ...
        generateMastCellMesh(scale = 1.0) {
            ...
            vertices.push(...soma.vertices.map(v => (Object.assign(Object.assign({}, v), { color: '#D0D0D0' })))); // Premium Gray soma
        ...
        generateGliaMesh(type, scale = 1.0) {
            ...
            vertices.push(...soma.vertices.map(v => (Object.assign(Object.assign({}, v), { color: baseColor }))));
            faces.push(...soma.faces);
            for (let i = 0; i < branches; i++) {
                ...
                const offset = vertices.length;
                vertices.push(...tube.vertices.map(v => (Object.assign(Object.assign({}, v), { color: baseColor }))));
