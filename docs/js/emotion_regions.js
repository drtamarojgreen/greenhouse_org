...
(function () {
    ...
    const emotionalRegulationEnhancements = [
        ...
        { id: 12, name: 'Interoceptive Awareness Scale', description: 'Tool to simulate the Insula\'s role in sensing internal bodily states and its subsequent impact on emotion.', regions: ['thalamus'], wellnessFocus: 'Somatic Mindfulness', conditionMapping: 'Somatic Symptom Disorders' },
        ...
        { id: 21, name: 'Anterior Cingulate Cortex (ACC) Highlight', description: 'Visualization of the ACC\'s role in detecting conflicts between emotional impulses and goals.', regions: ['prefrontalCortex'], wellnessFocus: 'Conflict Resolution', conditionMapping: 'Obsessive-Compulsive Tendencies' },
        { id: 22, name: 'Dopamine Reward Prediction Error', description: 'Visualization of how unexpected positive outcomes regulate mood via the Ventral Striatum.', regions: ['thalamus', 'hypothalamus'], wellnessFocus: 'Reward Optimization', conditionMapping: 'Anhedonia' },
