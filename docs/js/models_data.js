...
const GreenhouseModelsData = {
    ...
    loadData() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dataElement = yield new Promise((resolve) => {
                    let elapsedTime = 0;
    ...
    transformNotesToSimulationInput(rawNotes, lexicon) {
        ...
        if (rawNotes) {
            rawNotes.forEach(note => {
                ...
                const domainTags = extractTags(sanitizedContent, lexicon === null || lexicon === void 0 ? void 0 : lexicon.domain_tags);
                const neuroAffinities = extractTags(sanitizedContent, lexicon === null || lexicon === void 0 ? void 0 : lexicon.neurotransmitter_affinity);
                const nodeLabel = createLabel(sanitizedContent);
                if (!tempNodeMap.has(nodeLabel)) {
                    let strengthPrior = 0.5;
                    if (sourceType === "research")
                        strengthPrior = 0.75;
                    else if (sourceType === "patient")
                        strengthPrior = 0.4;
    ...
    update(networkState) {
        if (!this.state.processedSimulation)
            return;
