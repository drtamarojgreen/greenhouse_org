        ...
        setupMappings() {
            this.mappings = {
                ...
                62: (ctx, w, h) => {
                    ...
                    ctx.strokeRect(w * 0.35 - 20, h * 0.35 - 20, 40, 40);
                    ctx.fillStyle = '#FFFFFF';
                    ctx.fillText(t('cog_label_exec_stimulation'), w * 0.35 - 50, h * 0.35 + 40);
                },
                63: (ctx, w, h) => {
                    const time = Date.now() * 0.005;
                    ...
                    ctx.beginPath();
                    ctx.arc(bx, h * 0.5, 10, 0, Math.PI * 2);
                    ctx.fill();
                ...
                71: (ctx, w, h) => {
                    ...
                    ctx.fillStyle = '#E0E0E0';
                    ctx.fillRect(x - 40, y - th, 30, th);
                    ctx.fillStyle = '#A0AEC0';
                    ctx.fillRect(x + 10, y - bh, 30, bh);
                    ctx.fillStyle = '#fff';
                    ctx.font = '10px Arial';
                ...
                79: (ctx, w, h) => {
                    ...
                    ctx.fill();
                    ctx.fillStyle = '#fff';
                    ctx.fillText('SCN Photostimulation', x - 50, y + 70);
                },
                80: (ctx, w, h) => {
