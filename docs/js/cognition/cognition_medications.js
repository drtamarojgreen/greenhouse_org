        ...
        setupMappings() {
            this.mappings = {
                ...
                91: (ctx, w, h) => {
                    ...
                    ctx.fillStyle = color;
                    ctx.fillText(t('cog_label_bbb_permeability'), x - 100, y + 80);
                },
                92: (ctx, w, h) => {
                    ...
                    ctx.fillStyle = color;
                    ctx.fillText(t('cog_label_receptor_occupancy'), x - 60, y + 40);
                },
                93: (ctx, w, h) => {
                    const x = w * 0.5, y = h * 0.5, color = '#D0D0D0';
                    ctx.fillStyle = '#333';
                ...
                94: (ctx, w, h) => {
                    ...
                    ctx.stroke();
                    ctx.fillStyle = color;
                    ctx.fillText(t('cog_label_withdrawal_rebound'), x - 60, y + 50);
                },
                95: (ctx, w, h) => {
                ...
                98: (ctx, w, h) => {
                    ...
                    ctx.fillText(t('cog_label_orphan_receptor'), x - 60, y + 50);
                },
                99: (ctx, w, h) => {
                    const x = w * 0.5, y = h * 0.5;
