...
(function () {
    ...
    const GreenhouseGeneticProtein = {
        ...
        drawProteinView(ctx, x, y, w, h, activeGene, proteinCache, drawPiPFrameCallback, cameraState) {
            ...
            const mat = ((_a = config.materials) === null || _a === void 0 ? void 0 : _a.protein) || {};
            if (drawPiPFrameCallback) {
                const title = this.isGPCR(activeGene === null || activeGene === void 0 ? void 0 : activeGene.label) ? t("gpcr_title") : t("Protein Structure");
