...
// Enhanced Lighting System for Genetic Models (adapted from neuro_lighting.js)
...
(function () {
    ...
    const GreenhouseGeneticLighting = {
        ...
        init(config) {
            ...
            this.setupLights();
            console.log('GeneticLighting: Enhanced System initialized');
        },
