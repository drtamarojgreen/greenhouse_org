    ...
    const GreenhouseGeneticUI3D = {
        ...
        init(container, algo, selector = null) {
            ...
            if (window.GreenhouseGeneticCameraController)
                this.mainCameraController = new window.GreenhouseGeneticCameraController(this.camera, window.GreenhouseGeneticConfig);
            this.setupDOM();
            this.resize();
        ...
        addStartOverlay(container) {
            ...
            btn.onclick = () => { this.isEvolving = true; overlay.style.display = 'none'; if (window.GreenhouseGenetic)
        ...
        setupInteraction() {
            this.canvas.addEventListener('mousedown', e => {
                var _a, _b;
                if ((_a = window.GreenhouseGeneticPiPControls) === null || _a === void 0 ? void 0 : _a.handleMouseDown(e, this.canvas))
                    return;
                (_b = this.mainCameraController) === null || _b === void 0 ? void 0 : _b.handleMouseDown(e);
            });
            window.addEventListener('mouseup', () => {
                var _a, _b;
                (_a = window.GreenhouseGeneticPiPControls) === null || _a === void 0 ? void 0 : _a.handleMouseUp();
                (_b = this.mainCameraController) === null || _b === void 0 ? void 0 : _b.handleMouseUp();
            });
            window.addEventListener('mousemove', e => {
                var _a, _b;
                if ((_a = window.GreenhouseGeneticPiPControls) === null || _a === void 0 ? void 0 : _a.handleMouseMove(e))
                    return;
                (_b = this.mainCameraController) === null || _b === void 0 ? void 0 : _b.handleMouseMove(e);
            });
            this.canvas.addEventListener('wheel', e => {
                var _a, _b;
                if ((_a = window.GreenhouseGeneticPiPControls) === null || _a === void 0 ? void 0 : _a.handleWheel(e, this.canvas))
                    return;
                e.preventDefault();
                (_b = this.mainCameraController) === null || _b === void 0 ? void 0 : _b.handleWheel(e);
            }, { passive: false });
        },
        updateData() {
            var _a, _b;
            if (!((_a = this.algo) === null || _a === void 0 ? void 0 : _a.bestNetwork))
                return;
            const net = this.algo.bestNetwork;
            if (!this.brainShell) {
                this.brainShell = { vertices: [], faces: [] };
                (_b = window.GreenhouseGeneticGeometry) === null || _b === void 0 ? void 0 : _b.initializeBrainShell(this.brainShell);
            }
            this.neurons3D = net.nodes.map((node, i) => {
                var _a, _b;
                const isGenotype = i < net.nodes.length / 2;
                if (isGenotype) {
                    const helixData = (_a = window.GreenhouseGeneticGeometry) === null || _a === void 0 ? void 0 : _a.generateHelixPoints(i, net.nodes.length, -400);
                    return Object.assign(Object.assign({}, node), { x: helixData.x, y: helixData.y, z: helixData.z, type: 'gene', strand: helixData.strandIndex, label: GENE_SYMBOLS[i % GENE_SYMBOLS.length], baseColor: '#E0E0E0' });
                }
                else {
                    ...
                    const vertices = ((_b = window.GreenhouseGeneticGeometry) === null || _b === void 0 ? void 0 : _b.getRegionVertices(this.brainShell, regionKey)) || [];
                    const v = this.brainShell.vertices[vertices[i % vertices.length]] || { x: 0, y: 0, z: 0 };
                    return Object.assign(Object.assign({}, node), { x: v.x * 0.8, y: v.y * 0.8, z: v.z * 0.8, type: 'neuron', region: regionKey, baseColor: '#E0E0E0' });
                }
            });
        },
        startAnimation() {
            const animate = () => {
                var _a, _b;
                (_a = this.mainCameraController) === null || _a === void 0 ? void 0 : _a.update();
                (_b = window.GreenhouseGeneticPiPControls) === null || _b === void 0 ? void 0 : _b.update();
                this.render();
        ...
        render() {
            ...
            this.drawTargetView(ctx, 0, 0, w, h, activeGene, this.activeGeneIndex, this.brainShell, null, { camera: this.camera, activeGene: activeGene }); // Pass main camera
            ...
            this.drawMicroView(ctx, rightPipX, gap, pipW, pipH, activeGene, this.activeGeneIndex, this.neuronMeshes, (ctx, x, y, w, h) => drawPiPFrame(ctx, x, y, w, h, t('pip_micro') + geneLabel), microState);
            if (window.GreenhouseGeneticPiPControls) {
            ...
            this.drawProteinView(ctx, rightPipX, proteinY, pipW, pipH, activeGene, this.proteinCache, (ctx, x, y, w, h) => drawPiPFrame(ctx, x, y, w, h, t('pip_protein') + geneLabel), proteinState);
            if (window.GreenhouseGeneticPiPControls) {
            ...
            this.drawTargetView(ctx, rightPipX, targetY, pipW, pipH, activeGene, this.activeGeneIndex, this.brainShell, (ctx, x, y, w, h) => drawPiPFrame(ctx, x, y, w, h, t('pip_target') + geneLabel), Object.assign(Object.assign({}, targetState), { activeGene: activeGene }));
            if (window.GreenhouseGeneticPiPControls) {
        ...
        drawMacroView(ctx, w, h) {
            if (window.GreenhouseGeneticDNA) {
                this.projectedGenes = window.GreenhouseGeneticDNA.drawMacroView(ctx, w, h, this.camera, this.projection, this.neurons3D, this.activeGeneIndex, this.brainShell, this.drawNeuron.bind(this), // Callback for drawing individual genes/neurons
        ...
        drawMicroView(ctx, x, y, w, h, activeGene, activeGeneIndex, neuronMeshes, drawPiPFrameCallback, cameraState) {
            ...
            if (window.GreenhouseGeneticGene) {
                window.GreenhouseGeneticGene.drawMicroView(ctx, x, y, w, h, activeGene, activeGeneIndex, neuronMeshes, drawPiPFrameCallback, cameraState);
            }
            else if (window.GreenhouseGeneticChromosome) {
                // Fallback or alternative view
                window.GreenhouseGeneticChromosome.drawChromosome(ctx, x, y, w, h, activeGene, drawPiPFrameCallback);
            }
            ctx.restore();
        },
        drawTargetView(ctx, x, y, w, h, activeGene, activeGeneIndex, brainShell, drawPiPFrameCallback, cameraState) {
            ...
            if (window.GreenhouseGeneticBrain) {
                window.GreenhouseGeneticBrain.drawTargetView(ctx, x, y, w, h, activeGene, activeGeneIndex, brainShell, drawPiPFrameCallback, cameraState);
            }
            ctx.restore();
        },
        drawProteinView(ctx, x, y, w, h, activeGene, proteinCache, drawPiPFrameCallback, cameraState) {
            ...
            if (window.GreenhouseGeneticProtein) {
                window.GreenhouseGeneticProtein.drawProteinView(ctx, x, y, w, h, activeGene, proteinCache, drawPiPFrameCallback, cameraState);
            }
            ctx.restore();
        },
        ...
        handleMouseClick(e) {
            ...
            if (window.GreenhouseGeneticProtein) {
                ...
                const protW = pipW;
                const protH = pipH;
                const protHit = window.GreenhouseGeneticProtein.hitTest(mouseX, mouseY, protX, protY, protW, protH, this.neurons3D[this.activeGeneIndex], this.proteinCache);
                if (protHit) {
        ...
        drawSynapticCues(ctx) {
            ...
            neurons.forEach(n => {
                ...
                if (p.scale > 0.4) {
                    ...
                    const activation = (_a = n.activation) !== null && _a !== void 0 ? _a : 0;
                    if (activation > 0.5) {
        ...
        drawDNAHelixPiP(ctx, x, y, w, h, cameraState, drawPiPFrame) {
            ...
            if (window.GreenhouseGeneticDNA) {
                ...
                dnaGenes.forEach((n, i) => {
                    const p = GreenhouseModels3DMath.project3DTo2D(n.x, // Don't offset - genes are already positioned
                    n.y, n.z, pipCamera, pipProjection);
                    if (p.scale > 0) {
                        projectedGenes.push(Object.assign(Object.assign({}, n), p));
                    }
                });
                // Sort by depth
                ...
                projectedGenes.forEach(p => {
                    ...
                    if (baseColors) {
                        switch (type) {
                            case 0:
                                color = p.strand === 0 ? baseColors.A : baseColors.T;
                                break;
                            case 1:
                                color = p.strand === 0 ? baseColors.T : baseColors.A;
                                break;
                            case 2:
                                color = p.strand === 0 ? baseColors.C : baseColors.G;
                                break;
                            case 3:
                                color = p.strand === 0 ? baseColors.G : baseColors.C;
                                break;
                        }
                    }
                    else {
        ...
        drawRotatingCube(ctx, x, y, w, h, cameraState) {
            ...
            const rotY = ((_a = cameraState.camera) === null || _a === void 0 ? void 0 : _a.rotationY) || cameraState.rotationY || 0;
            const rotX = ((_b = cameraState.camera) === null || _b === void 0 ? void 0 : _b.rotationX) || cameraState.rotationX || 0;
            ...
            // Project vertices
            const projected = cubeVertices.map(v => GreenhouseModels3DMath.project3DTo2D(v.x, v.y, v.z, cubeCamera, cubeProjection));
            // Draw cube edges
            const edges = [
        ...
        drawConnections(ctx) {
            ...
            const sortedConnections = this.connections3D
                ...
                return Object.assign(Object.assign({}, conn), { avgZ });
            })
                .sort((a, b) => b.avgZ - a.avgZ);
            sortedConnections.forEach(conn => {
                // Skip drawing connections to or from the 'gene' type display
                if (conn.from.type === 'gene' || conn.to.type === 'gene')
                    return;
                ...
                const projectedVertices = mesh.vertices.map(v => GreenhouseModels3DMath.project3DTo2D(v.x, v.y, v.z, this.camera, this.projection));
