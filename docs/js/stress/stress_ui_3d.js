...
(function () {
    ...
    const GreenhouseStressUI3D = {
        ...
        init(app) {
            ...
            this.hpaNodes = [
                { id: 'pfc', label: 'label_pfc', x: -80, y: 180, z: 20, color: '#E0E0E0', type: 'regulator', function: 'inhibitor', mesh: Geo.generateSphere(28, 12) },
                { id: 'amygdala', label: 'label_amygdala', x: 80, y: 150, z: 0, color: '#A0AEC0', type: 'regulator', function: 'excitor', mesh: Geo.generateSphere(16, 12) },
                { id: 'hippocampus', label: 'label_hippocampus', x: -60, y: 100, z: -40, color: '#E0E0E0', type: 'regulator', function: 'inhibitor', mesh: Geo.generateSphere(22, 12) },
                { id: 'hypothalamus', label: 'label_hypothalamus', x: 0, y: 50, z: 0, color: '#D0D0D0', type: 'core', mesh: Geo.generateSphere(25, 12) },
                { id: 'pituitary', label: 'label_pituitary', x: 0, y: -20, z: 40, color: '#A0AEC0', type: 'core', mesh: Geo.generateSphere(14, 12) },
                { id: 'adrenals', label: 'label_adrenal_glands', x: 0, y: -200, z: -20, color: '#E0E0E0', type: 'core', mesh: Geo.generateSphere(35, 12) }
            ];
        ...
        loadPathways() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const data = yield window.GreenhouseModelsUtil.PathwayService.loadMetadata(baseUrl);
                this.availablePathways = data.pathways;
                // Pre-load HPA for seamless start
                yield this.fetchPathway('hpa');
            });
        },
        fetchPathway(id) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const baseUrl = (this.app && this.app.baseUrl) ? this.app.baseUrl : '';
                const data = yield window.GreenhouseModelsUtil.PathwayService.loadPathway(meta.source, baseUrl);
                if (data) {
                    ...
                    const nodesWithPos = nodes.map((n, i) => {
                        ...
                        return Object.assign(Object.assign({}, n), pos);
                    });
