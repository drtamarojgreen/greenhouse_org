    ...
    const GreenhouseModelsUtil = {
        ...
        translations: {
            en: {
                ...
                cat_philosophies: "World Philosophical Frameworks",
                cat_regulations: "Emotional Regulation",
                cat_therapeutic: "Therapeutic Effects",
                cat_medication: "Medication Treatments",
                cat_advanced: "Regulation Theories",
                cat_analytical: "Analytical",
                cat_development: "Development",
                cat_intervention: "Intervention",

                // Internal Simulation UI
                gen: "Gen",
                fitness: "Fitness",
                best_fitness: "Best Fitness",
                initializing: "Initializing...",
                connecting_kegg: "Connecting to KEGG...",
                ...
                // Model Modes
                'Phenotype Evolution': 'Phenotype Evolution',
                'Genotype Mapping': 'Genotype Mapping',
                'Protein Synthesis': 'Protein Synthesis',
                'Neural Network': 'Neural Network',
                'Synaptic Density': 'Synaptic Density',
                'Burst Patterns': 'Burst Patterns',
                'Basal Ganglia': 'Basal Ganglia',
                'Dopamine Loop': 'Dopamine Loop',
                'Serotonin Path': 'Serotonin Path',
                ...
                'Pseudouridylation': 'Pseudouridylation',
                'Decapping': 'Decapping',
                'D1R Signaling': 'D1R Signaling',
                'D2R Signaling': 'D2R Signaling',
                'Synaptic Release': 'Synaptic Release',
                'Circuit Dynamics': 'Circuit Dynamics',
                '3D Receptor': '3D Receptor',
                '5-HT1A Structural': '5-HT1A Structural',
                '2D Closeup': '2D Closeup',
                'Ligand Kinetics': 'Ligand Kinetics',
                'James-Lange': 'James-Lange',
                'Cannon-Bard': 'Cannon-Bard',
                ...
                'PFC Signaling': 'PFC Signaling',
                'SSRI blockade': 'SSRI blockade',
                'Cocaine': 'Cocaine',
                ...
                'Search 200 enhancements...': 'Search 200 enhancements...',
                'Subtype Glyphs': 'Subtype Glyphs',
                'Stereoscopic Mode (VR)': 'Stereoscopic Mode (VR)',
                ...
                'Occupancy Panel': 'Occupancy Panel',
                'Metabolic Gauges': 'Metabolic Gauges',
                'Heatmap Overlay': 'Heatmap Overlay',
                'Comparison View': 'Comparison View',
                'Interactive Legend': 'Interactive Legend',
                'Anatomical Environment': 'Anatomical Environment',
                'Depression': 'Depression',
                'Serotonin Syndrome': 'Serotonin Syndrome',
                'MDMA Scenario': 'MDMA Scenario',
                'Migraine / Triptans': 'Migraine / Triptans',
                'Research Scenario': 'Research Scenario',
                'Select Research Scenario': 'Select Research Scenario',
                'Select Neurotransmitter': 'Select Neurotransmitter',
                'Neural Anatomy': 'Neural Anatomy',
                'Mechanics & Pathophysiology': 'Mechanics & Pathophysiology',
                'Pre-Synaptic Terminal': 'Pre-Synaptic Terminal',
                'Post-Synaptic Terminal': 'Post-Synaptic Terminal',
                'Research Controls': 'Research Controls',
                'Trigger Synaptic Vesicle Burst': 'Trigger Synaptic Vesicle Burst',
                'Burst': 'Burst',
                'Set Baseline': 'Set Baseline',
                'Pharmacological Panel': 'Pharmacological Panel',
                'Research Tools': 'Research Tools',
                'Ruler': 'Ruler',
                'Annotate': 'Annotate',
                'Calcium-FL': 'Calcium-FL',
                'Literature': 'Literature',
                'Generate Research Figure': 'Generate Research Figure',
                'Error loading model descriptions. Please try again later.': 'Error loading model descriptions. Please try again later.',
                ...
                'Dopamine Signaling Model': 'Dopamine Signaling Model',
                'Serotonin Structural Model': 'Serotonin Structural Model',
                'DNA Repair Model': 'DNA Repair Model',
                'RNA Repair Model': 'RNA Repair Model',
                'Emotion Model': 'Emotion Model',
                'Cognition Model': 'Cognition Model',
            ...
            es: {
                ...
                hub_title: "Modelos Greenhouse",
                btn_select_model: "Seleccionar Modelo",
                btn_close: "Cerrar",

                cat_philosophies: "Marcos Filosóficos Mundiales",
                cat_regulations: "Regulación Emocional",
                cat_therapeutic: "Efectos Terapéuticos",
                cat_medication: "Tratamientos Médicos",
                cat_advanced: "Teorías de Regulación",
                cat_analytical: "Analítico",
                cat_development: "Desarrollo",
                cat_intervention: "Intervención",
                ...
                connecting_kegg: "Conectando a KEGG...",
                select_focus: "-- Seleccionar foco --",
                pathway_control: "Control de Vías",
                ...
                ph: "pH",
                temp: "Temp",
                glass_brain: "Cerebro de Cristal",
                reset_view: "Restablecer Vista",
                on: "Encendido",
                off: "Apagado",

                // Model Modes
                'Phenotype Evolution': 'Evolución del Fenotipo',
                'Genotype Mapping': 'Mapeo del Genotipo',
                'Protein Synthesis': 'Síntesis de Proteínas',
                'Neural Network': 'Red Neuronal',
                'Synaptic Density': 'Densidad Sináptica',
                'Burst Patterns': 'Patrones de Ráfaga',
                'Basal Ganglia': 'Ganglios Basales',
                'Dopamine Loop': 'Bucle de Dopamina',
                'Serotonin Path': 'Vía de Serotonina',
                'Clean Signal': 'Señal Limpia',
                'Inhibited': 'Inhibido',
                'Excited': 'Excitado',
                'Base Excision': 'Escisión de Base',
                'Mismatch Repair': 'Reparación de Desajustes',
                'Nucleotide Excision': 'Escisión de Nucleótidos',
                'Double-Strand Break': 'Rotura de Doble Cadena',
                'Ligation': 'Ligación',
                'Demethylation': 'Desmetilación',
                'Pseudouridylation': 'Pseudouridilación',
                'Decapping': 'Descaperuzamiento',
                'D1R Signaling': 'Señalización D1R',
                'D2R Signaling': 'Señalización D2R',
                'Synaptic Release': 'Liberación Sináptica',
                'Circuit Dynamics': 'Dinámica del Circuito',
                '3D Receptor': 'Receptor 3D',
                '5-HT1A Structural': 'Estructural 5-HT1A',
                '2D Closeup': 'Primer Plano 2D',
                'Ligand Kinetics': 'Cinética del Ligando',
                'James-Lange': 'James-Lange',
                'Cannon-Bard': 'Cannon-Bard',
                'Schachter-Singer': 'Schachter-Singer',
                ...
                'Ventral Striatum': 'Estriado Ventral',
                'PFC Signaling': 'Señalización del CPF',
                'SSRI blockade': 'Bloqueo de ISRS',
                'Cocaine': 'Cocaína',
                'Amphetamine': 'Anfetamina',
                'Parkinsonian': 'Parkinsoniano',
                'Alpha-Synuclein': 'Alfa-Sinucleína',
                'Neuroinflammation': 'Neuroinflamación',
                'High Stress': 'Alto Estrés',
                ...
                'Search 200 enhancements...': 'Buscar 200 mejoras...',
                'Subtype Glyphs': 'Glifos de Subtipo',
                'Stereoscopic Mode (VR)': 'Modo Estereoscópico (VR)',
                'Deuteranopia': 'Deuteranopia',
                'Protanopia': 'Protanopia',
                'Tritanopia': 'Tritanopia',
                'Cinematic FX': 'FX Cinemáticos',
                'PBR Materials': 'Materiales PBR',
                'Dynamic Lighting': 'Iluminación Dinámica',
                'Occupancy Panel': 'Panel de Ocupación',
                'Metabolic Gauges': 'Indicadores Metabólicos',
                'Heatmap Overlay': 'Superposición de Mapa de Calor',
                'Comparison View': 'Vista de Comparación',
                'Interactive Legend': 'Leyenda Interactiva',
                'Anatomical Environment': 'Entorno Anatómico',
                'Depression': 'Depresión',
                'Serotonin Syndrome': 'Síndrome Serotoninérgico',
                'MDMA Scenario': 'Escenario MDMA',
                'Migraine / Triptans': 'Migraña / Triptanos',
                'Research Scenario': 'Escenario de Investigación',
                'Select Research Scenario': 'Seleccionar Escenario de Investigación',
                'Select Neurotransmitter': 'Seleccionar Neurotransmisor',
                'Neural Anatomy': 'Anatomía Neuronal',
                'Mechanics & Pathophysiology': 'Mecánica y Fisiopatología',
                'Pre-Synaptic Terminal': 'Terminal Presináptica',
                'Post-Synaptic Terminal': 'Terminal Postsináptica',
                'Research Controls': 'Controles de Investigación',
                'Trigger Synaptic Vesicle Burst': 'Activar Ráfaga de Vesículas Sinápticas',
                'Burst': 'Ráfaga',
                'Set Baseline': 'Establecer Línea Base',
                'Pharmacological Panel': 'Panel Farmacológico',
                'Research Tools': 'Herramientas de Investigación',
                'Ruler': 'Regla',
                'Annotate': 'Anotar',
                'Calcium-FL': 'Calcio-FL',
                'Literature': 'Literatura',
                'Generate Research Figure': 'Generar Figura de Investigación',
                'Error loading model descriptions. Please try again later.': 'Error al cargar las descripciones de los modelos. Por favor, inténtelo de nuevo más tarde.',

                // Model Titles
                'Genetic Model': 'Modelo Genético',
                'Neuro Model': 'Modelo Neuro',
                'Pathway Model': 'Modelo de Vías',
                'Synapse Model': 'Modelo de Sinapsis',
                'Dopamine Signaling Model': 'Modelo de Señalización de Dopamina',
                'Serotonin Structural Model': 'Modelo Estructural de Serotonina',
                'DNA Repair Model': 'Modelo de Reparación de ADN',
                'RNA Repair Model': 'Modelo de Reparación de ARN',
                'Emotion Model': 'Modelo de Emociones',
                'Cognition Model': 'Modelo de Cognición',
        ...
        toggleLanguage() {
            ...
            window.dispatchEvent(new CustomEvent('greenhouse:language-changed', { detail: this.currentLanguage }));
