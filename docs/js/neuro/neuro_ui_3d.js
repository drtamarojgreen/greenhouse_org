        ...
        setupInteraction() {
            this.canvas.addEventListener('mousedown', e => {
                ...
                if (this.selectedConnection) {
                    if (isPiP)
                        (_a = this.networkCameraController) === null || _a === void 0 ? void 0 : _a.handleMouseDown(e);
                    else
                        (_b = this.synapseCameraController) === null || _b === void 0 ? void 0 : _b.handleMouseDown(e);
                }
                else {
                    (_c = this.networkCameraController) === null || _c === void 0 ? void 0 : _c.handleMouseDown(e);
                }
            });
            window.addEventListener('mousemove', e => {
                var _a, _b;
                (_a = this.networkCameraController) === null || _a === void 0 ? void 0 : _a.handleMouseMove(e);
                (_b = this.synapseCameraController) === null || _b === void 0 ? void 0 : _b.handleMouseMove(e);
            });
            ...
            this.canvas.addEventListener('wheel', e => {
                ...
                if (this.isMouseOverPiP(mouseX, mouseY))
                    (_a = this.networkCameraController) === null || _a === void 0 ? void 0 : _a.handleWheel(e);
                else
                    (_b = this.synapseCameraController) === null || _b === void 0 ? void 0 : _b.handleWheel(e);
            }, { passive: false });
