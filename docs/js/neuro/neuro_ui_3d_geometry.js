        ...
        initializeBrainShell(brainShell) {
            ...
            for (let lat = 0; lat <= latitudeBands; lat++) {
                ...
                for (let lon = 0; lon <= longitudeBands; lon++) {
                    ...
                    // 5. Region-Specific Surface Noise (The brain surface 'wrinkles')
            ...
            // Using a sophisticated, monochromatic grayscale palette with structural differentiation
            brainShell.regions = {
                pfc: {
            ...
            // Apply Mesh Beveling for boundary grooves
