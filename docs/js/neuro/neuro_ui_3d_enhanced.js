...
const GreenhouseNeuroUI3D = {
    ...
    updateData(genome) {
        ...
        this.neurons = genome.neurons.map((n, i) => {
            ...
            if (existingNeuron) {
                return Object.assign(Object.assign({}, n), { x: existingNeuron.x, y: existingNeuron.y, z: existingNeuron.z, region: existingNeuron.region, baseColor: existingNeuron.baseColor, radius: existingNeuron.radius });
            }
            ...
            return Object.assign(Object.assign({}, n), { x, y, z, region: regionKey, baseColor: baseColor, radius: 6 + Math.random() * 4 });
        });
    ...
    initializeConnections(connections) {
        ...
        this.connections = connections.map(conn => {
            ...
            return Object.assign(Object.assign({}, conn), { from: fromNeuron, to: toNeuron, controlPoint: cp, mesh: mesh, id: connectionId });
        }).filter(c => c !== null);
    ...
    render() {
        ...
        const ga = (_a = window.GreenhouseNeuroApp) === null || _a === void 0 ? void 0 : _a.ga;
        const adhd = ga === null || ga === void 0 ? void 0 : ga.adhdConfig;
        // ADHD: Time Perception Distortion (Enhancement 12)
        if ((_b = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _b === void 0 ? void 0 : _b.has(12)) {
            if (Math.random() < 0.05) {
        ...
        if ((_c = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _c === void 0 ? void 0 : _c.has(7)) {
            ctx.globalAlpha = Math.max(0.3, adhd.sustainedAttention);
        }
        // ADHD: Attentional Blink (Enhancement 1)
        if (((_d = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _d === void 0 ? void 0 : _d.has(1)) && adhd.blinkCooldown > 0) {
            ctx.fillStyle = 'rgba(255, 255, 255, 0.2)';
            ctx.fillRect(0, 0, this.canvas.width, this.canvas.height);
            // Skip further rendering to simulate perception "blink"
            if (adhd.blinkCooldown > 2)
                return;
        }
        // ADHD: Global Jitter (Enhancement 14/40)
        let shakeX = 0, shakeY = 0;
        const jitterFactor = ((_e = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _e === void 0 ? void 0 : _e.has(40)) ? 0.2 : 1.0;
        if ((_f = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _f === void 0 ? void 0 : _f.has(14)) {
        ...
        if (((_g = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _g === void 0 ? void 0 : _g.has(6)) && adhd.taskSwitchingLatency > 0) {
            ctx.filter = 'blur(4px)';
        }
        // ADHD: Hyperfocus Tunneling (Enhancement 20)
        if ((_h = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _h === void 0 ? void 0 : _h.has(20)) {
        ...
        if ((_j = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _j === void 0 ? void 0 : _j.has(2)) {
            this.drawNoiseParticles(ctx);
        }
        // ADHD: Treatment - Therapeutic Alliance Glow (Enhancement 49)
        if ((_k = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _k === void 0 ? void 0 : _k.has(49)) {
            ctx.save();
            ctx.shadowBlur = 20;
            ctx.shadowColor = 'gold';
        }
        // ADHD: Pathology - Neuroinflammation (Enhancement 65)
        if ((_l = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _l === void 0 ? void 0 : _l.has(65)) {
        ...
        if ((_m = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _m === void 0 ? void 0 : _m.has(10)) {
            this.drawGatingVisuals(ctx, pipX, pipY, pipW, pipH);
        }
        // ADHD: Emotional Lability Spikes (Enhancement 11)
        if (((_o = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _o === void 0 ? void 0 : _o.has(11)) && Math.random() < 0.1) {
            this.drawAmygdalaSpike(ctx, pipX, pipY, pipW, pipH);
        }
        // ADHD: Response Variability Graph (Enhancement 17)
        if ((_p = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _p === void 0 ? void 0 : _p.has(17)) {
            this.drawResponseVariabilityGraph(ctx, 20, 20, 150, 60, ga);
        }
        // ADHD: Distractibility Index (Enhancement 15)
        if ((_q = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _q === void 0 ? void 0 : _q.has(15)) {
            this.drawDistractibilityIndex(ctx, 20, 90, ga);
        }
        // ADHD: Hereditability Tree (Enhancement 92)
        if ((_r = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _r === void 0 ? void 0 : _r.has(92)) {
            this.drawHereditabilityTree(ctx, 20, 230, ga);
        }
        // ADHD: Executive Assistant UI (Enhancement 42)
        if ((_s = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _s === void 0 ? void 0 : _s.has(42)) {
            this.drawExecutiveAssistant(ctx, ga);
        }
        // ADHD: Impulse Inhibition Meter (Enhancement 25)
        if ((_t = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _t === void 0 ? void 0 : _t.has(25)) {
            this.drawImpulseInhibitionMeter(ctx, 20, 130, ga);
        }
        // ADHD: Glutamate/GABA Imbalance Meter (Enhancement 62)
        if ((_u = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _u === void 0 ? void 0 : _u.has(62)) {
            this.drawGlutamateGabaMeter(ctx, 20, 180, ga);
        }
        if ((_v = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _v === void 0 ? void 0 : _v.has(49)) {
            ctx.restore();
        }
        if ((_w = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _w === void 0 ? void 0 : _w.has(14)) {
            ctx.restore();
        }
    ...
    drawTargets(ctx, w, h) {
        var _a;
        const ga = (_a = window.GreenhouseNeuroApp) === null || _a === void 0 ? void 0 : _a.ga;
        if (!ga || !ga.targetPoints)
            return;
        ga.targetPoints.forEach((target, i) => {
            const proj = window.GreenhouseModels3DMath.project3DTo2D(target.x, target.y, target.z, this.camera, { width: w, height: h, near: 10, far: 1000 });
            if (proj.scale > 0) {
    ...
    drawAmygdalaSpike(ctx, x, y, w, h) {
        ...
        const proj = window.GreenhouseModels3DMath.project3DTo2D(amygCenter.x, amygCenter.y, amygCenter.z, this.camera, { width: w, height: h, near: 10, far: 1000 });
        if (proj.scale > 0) {
            ctx.save();
    ...
    drawResponseVariabilityGraph(ctx, x, y, w, h, ga) {
        ...
        ctx.moveTo(0, h / 2);
        for (let i = 0; i < w; i++) {
            const val = Math.sin(i * 0.1 + Date.now() * 0.01) * 10 * (((_a = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _a === void 0 ? void 0 : _a.snr) || 1);
    ...
    drawDistractibilityIndex(ctx, x, y, ga) {
        ...
        const index = Math.floor((((_a = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _a === void 0 ? void 0 : _a.snr) || 0) * 100);
        ctx.fillStyle = '#fff';
        ctx.font = '12px Arial';
    ...
    drawExecutiveAssistant(ctx, ga) {
        const target = ga === null || ga === void 0 ? void 0 : ga.targetPoints[0];
        if (!target)
            return;
        const proj = window.GreenhouseModels3DMath.project3DTo2D(target.x, target.y, target.z, this.camera, this.projection);
        if (proj.scale > 0) {
            ctx.save();
    ...
    drawGlutamateGabaMeter(ctx, x, y, ga) {
        ...
        const ratio = ((_a = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _a === void 0 ? void 0 : _a.glutamateGabaRatio) || 1.0;
    ...
    drawImpulseInhibitionMeter(ctx, x, y, ga) {
        ...
        const connections = ((_a = ga === null || ga === void 0 ? void 0 : ga.population[0]) === null || _a === void 0 ? void 0 : _a.connections) || [];
    ...
    drawGatingVisuals(ctx, x, y, w, h) {
        ...
        const proj = window.GreenhouseModels3DMath.project3DTo2D(pfcCenter.x, pfcCenter.y, pfcCenter.z, this.camera, { width: w, height: h, near: 10, far: 1000 });
        if (proj.scale > 0) {
            ctx.save();
            ctx.translate(x + proj.x, y + proj.y);
    ...
    drawNoiseParticles(ctx) {
        ...
        if (adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements.has(39))
            return;
        // ADHD: Interference Sensitivity (Enhancement 8)
        const count = (adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements.has(8)) ? 150 : 50;
    ...
    drawNetworkView(ctx, x, y, w, h) {
        ...
        if (window.GreenhouseNeuroStats) {
            const labeledNeurons = sortedNeurons.map(item => (Object.assign(Object.assign({}, item.neuron), { x: item.projected.x, y: item.projected.y, region: item.neuron.region })));
    ...
    initializeBrainShell() {
        ...
        if (window.GreenhouseNeuroGeometry) {
            ...
            const ga = (_a = window.GreenhouseNeuroApp) === null || _a === void 0 ? void 0 : _a.ga;
            if ((_b = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _b === void 0 ? void 0 : _b.activeEnhancements.has(72)) {
                const pfcIndices = this.getRegionVertices('pfc');
                pfcIndices.forEach(idx => {
                    const v = this.brainShell.vertices[idx];
                    v.x *= 0.9;
                    v.y *= 0.9;
                    v.z *= 0.9; // Shrink PFC volume
                });
            }
        }
    },
    ...
    drawNeuron(ctx, neuron, camera, projection) {
        ...
        if (window.GreenhouseNeuroNeuron) {
            ...
            let pulseFreq = ((_b = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _b === void 0 ? void 0 : _b.has(3)) ? 0.01 : 0.005;
            if ((_c = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _c === void 0 ? void 0 : _c.has(38)) {
                pulseFreq = 0.008 + Math.sin(Date.now() * 0.005) * 0.002;
            }
            // ADHD: Cognitive Fatigue Shader (Enhancement 19)
            let colorOverride = null;
            if ((_d = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _d === void 0 ? void 0 : _d.has(19)) {
                const fatigue = (adhd === null || adhd === void 0 ? void 0 : adhd.fatigue) || 0;
                if (fatigue > 0.5) {
                    colorOverride = '#333'; // Darken
                }
            }
            // ADHD: Hypofrontality (52) / Striatal Hyper-Reactivity (53)
            if (((_e = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _e === void 0 ? void 0 : _e.has(52)) && neuron.region === 'pfc') {
                ctx.globalAlpha *= 0.4;
            }
            if (((_f = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _f === void 0 ? void 0 : _f.has(53)) && (neuron.region === 'striatum' || neuron.region === 'brainstem')) {
                ctx.save();
                ctx.shadowBlur = 15;
            ...
            if ((_g = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _g === void 0 ? void 0 : _g.has(13)) {
            ...
            let jitter = 0;
            if (((_h = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _h === void 0 ? void 0 : _h.has(14)) && neuron.region === 'motorCortex')
                jitter = 2;
            if ((_j = adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements) === null || _j === void 0 ? void 0 : _j.has(47))
                jitter = 4;
            if (jitter > 0) {
            ...
            ctx.restore();
            if ((adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements.has(53)) && (neuron.region === 'striatum' || neuron.region === 'brainstem')) {
                ctx.restore();
            }
        }
    },
    drawConnections(ctx, w, h) {
        ...
        if (window.GreenhouseNeuroSynapse) {
            ...
            if ((adhd === null || adhd === void 0 ? void 0 : adhd.activeEnhancements.has(75)) && Math.random() < 0.02) {
            ...
            const whiteMatterLoss = (_b = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _b === void 0 ? void 0 : _b.activeEnhancements.has(56);
    ...
    drawGrid(ctx) {
        ...
        const scaffolding = (_b = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _b === void 0 ? void 0 : _b.activeEnhancements.has(45);
        const size = 1000;
        ...
        for (let x = -size; x <= size; x += step) {
            const p1 = window.GreenhouseModels3DMath.project3DTo2D(x, y, -size, this.camera, this.projection);
            const p2 = window.GreenhouseModels3DMath.project3DTo2D(x, y, size, this.camera, this.projection);
        ...
        for (let z = -size; z <= size; z += step) {
            const p1 = window.GreenhouseModels3DMath.project3DTo2D(-size, y, z, this.camera, this.projection);
            const p2 = window.GreenhouseModels3DMath.project3DTo2D(size, y, z, this.camera, this.projection);
            if (p1.scale > 0 && p2.scale > 0) {
                ctx.beginPath();
                ctx.moveTo(p1.x, p1.y);
                ctx.lineTo(p2.x, p2.y);
        ...
        const origin = window.GreenhouseModels3DMath.project3DTo2D(0, y, 0, this.camera, this.projection);
        const xAxis = window.GreenhouseModels3DMath.project3DTo2D(size, y, 0, this.camera, this.projection);
        const zAxis = window.GreenhouseModels3DMath.project3DTo2D(0, y, size, this.camera, this.projection);
        if (origin.scale > 0) {
            if (xAxis.scale > 0)
                ctx.fillText(util ? util.t('X-Axis') : 'X-Axis', xAxis.x, xAxis.y);
            if (zAxis.scale > 0)
                ctx.fillText(util ? util.t('Z-Axis') : 'Z-Axis', zAxis.x, zAxis.y);
        }
    },
    handleMouseClick(e) {
    ...
    hitTest(mouseX, mouseY) {
        ...
        this.connections.forEach(conn => {
            if (!conn.controlPoint)
                return;
            const p = window.GreenhouseModels3DMath.project3DTo2D(conn.controlPoint.x, conn.controlPoint.y, conn.controlPoint.z, this.camera, this.projection);
            if (p.scale > 0) {
                const dx = localMouseX - p.x;
                const dy = localMouseY - p.y;
                const dist = Math.sqrt(dx * dx + dy * dy);
    ...
    handleTooltipMove(e) {
        ...
        const ga = (_a = window.GreenhouseNeuroApp) === null || _a === void 0 ? void 0 : _a.ga;
        const activeEnhancements = (_b = ga === null || ga === void 0 ? void 0 : ga.adhdConfig) === null || _b === void 0 ? void 0 : _b.activeEnhancements;
        if (!this.tooltipEl || !activeEnhancements || !activeEnhancements.size)
            return;
        const rect = this.canvas.getBoundingClientRect();
        ...
        if (!tooltipContent && window.GreenhouseNeuroSynapse && this.selectedConnection) {
            ...
            if (x < this.canvas.width - pipConfig.width - 20 || y < this.canvas.height - pipConfig.height - 20) {
                const synapseCamera = ((_c = window.GreenhouseNeuroSynapse.synapseCameraController) === null || _c === void 0 ? void 0 : _c.getCamera()) || {
        ...
        if (!tooltipContent && activeEnhancements.has(19)) {
            ...
            if (x < this.canvas.width - pipConfig.width - 20) {
                const fatigue = ((_f = (_e = (_d = window.GreenhouseNeuroApp) === null || _d === void 0 ? void 0 : _d.ga) === null || _e === void 0 ? void 0 : _e.adhdConfig) === null || _f === void 0 ? void 0 : _f.fatigue) || 0;
                if (fatigue > 0.5) {
