...
(function () {
    ...
    const GreenhouseNeuroApp = {
        ...
        setupUIComponents() {
            var _a, _b, _c, _d;
            const w = ((_b = (_a = this.ui3d) === null || _a === void 0 ? void 0 : _a.canvas) === null || _b === void 0 ? void 0 : _b.width) || 1000;
            const h = ((_d = (_c = this.ui3d) === null || _c === void 0 ? void 0 : _c.canvas) === null || _d === void 0 ? void 0 : _d.height) || 750;
            const offsetX = 15;
        ...
        handleMouseDown(e) {
                ...
                if (mx >= s.x && mx <= s.x + s.w && my >= s.y && my <= s.y + s.h) {
                    ...
                    if (!hit) {
                        ...
                        for (const c of filtered) {
                            ...
                            if (cy < scrollAreaY || cy + c.h > scrollAreaY + scrollAreaH)
                                continue;
                            if (mx >= c.x && mx <= c.x + c.w && my >= cy && my <= cy + c.h) {
                                if (this.state.adhdCategory === 'scenarios') {
                                    ...
                                    if (active)
                                        this.state.activeEnhancements.add(c.enhancementId);
                                    else
                                        this.state.activeEnhancements.delete(c.enhancementId);
                                    (_a = this.ga) === null || _a === void 0 ? void 0 : _a.setADHDEnhancement(c.enhancementId, active);
                                }
                                hit = true;
                                break;
                            }
            ...
            // 4. Camera Buttons
            if (!hit) {
                const w = ((_c = (_b = this.ui3d) === null || _b === void 0 ? void 0 : _b.canvas) === null || _c === void 0 ? void 0 : _c.width) || 1000;
                ...
                for (const b of this.ui.cameraButtons) {
                    ...
                    if (mx >= bx && mx <= bx + b.w && my >= 60 && my <= 60 + b.h) {
                        if (b.action === 'reset')
                            (_d = this.ui3d) === null || _d === void 0 ? void 0 : _d.resetCamera();
                        else if (b.action === 'rotate')
                            (_e = this.ui3d) === null || _e === void 0 ? void 0 : _e.toggleAutoRotate();
                        hit = true;
                        break;
                    }
                }
        ...
        handleMouseMove(e) {
            ...
            if (this.state.activeTab === 'sim')
                all.push(...this.ui.buttons, ...this.ui.sliders);
            if (this.state.activeTab === 'adhd') {
                const scrollAreaY = 160;
                const scrollAreaH = 320;
                const startY = 180;
                ...
                const visibleCheckboxes = this.getFilteredCheckboxes()
                    ...
                    const cy = currentY;
                    currentY += lineHeight;
                    return Object.assign(Object.assign({}, c), { y: cy });
                })
        ...
        updateSlider(mx, s) {
            ...
            if (this.ga)
                this.ga.adhdConfig.dosagePrecision = this.state.dosage;
        },
        refreshUIText() {
        ...
        drawUI(ctx, w, h) {
            ...
            // 3. Tab Content
            if (this.state.activeTab === 'sim')
                this.drawSimTab(ctx, offsetX);
            else if (this.state.activeTab === 'adhd')
                this.drawADHDTab(ctx, offsetX);
            else if (this.state.activeTab === 'synapse')
                this.drawSynapseTab(ctx, offsetX);
            // 4. Action Buttons
            ...
            this.ui.cameraButtons.forEach(b => {
                var _a;
                const bx = (b.action === 'reset') ? camPanelX + 15 : camPanelX + 130;
                Controls.drawButton(ctx, this, Object.assign(Object.assign({}, b), { x: bx, y: 60 }), (b.action === 'rotate' && ((_a = this.ui3d) === null || _a === void 0 ? void 0 : _a.autoRotate)));
            });
            // 6. Navigation Hint
        ...
        drawSimTab(ctx, offsetX) {
            ...
            const statsText = this.ga ? `${t('gen')}: ${this.ga.generation} | ${t('best_fitness')}: ${Math.round(((_a = this.ga.bestGenome) === null || _a === void 0 ? void 0 : _a.fitness) || 0)}` : t('initializing');
        ...
        drawADHDTab(ctx, offsetX) {
            ...
            this.getFilteredCheckboxes().forEach(c => {
                ...
                Controls.drawCheckbox(ctx, this, Object.assign(Object.assign({}, c), { y: currentY, w: panelW - 70 }), isChecked);
                currentY += lineHeight;
            });
            ctx.restore();
        ...
        drawSynapseTab(ctx, offsetX) {
            ...
            const Controls = window.GreenhouseNeuroControls;
            const panelW = this.ui.panelW || 350;
            if (!((_a = this.ui3d) === null || _a === void 0 ? void 0 : _a.selectedConnection)) {
                ctx.fillStyle = '#fff';
        ...
        startSimulation() {
            if (this.isRunning)
                return;
            this.isRunning = true;
            if (this.ga && typeof this.ga.start === 'function')
                this.ga.start();
            if (this.ui3d && typeof this.ui3d.startAnimation === 'function')
        ...
        stopSimulation() {
            ...
            if (this.ga && typeof this.ga.stop === 'function')
                this.ga.stop();
            if (this.ui3d && typeof this.ui3d.stopAnimation === 'function')
        ...
        toggleScenario(scenarioId, active) {
            if (active) {
                window.GreenhouseADHDData.scenarios[scenarioId].enhancements.forEach(enhId => {
                    ...
                    (_a = this.ga) === null || _a === void 0 ? void 0 : _a.setADHDEnhancement(enhId, true);
                });
            }
            else {
                window.GreenhouseADHDData.scenarios[scenarioId].enhancements.forEach(enhId => {
                    ...
                    (_a = this.ga) === null || _a === void 0 ? void 0 : _a.setADHDEnhancement(enhId, false);
                });
            }
