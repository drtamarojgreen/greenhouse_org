(function () {
    ...
    window.GreenhouseEnvironmentConfig = {
        ...
        labels: [
            { text: 'Environmental Stress', x: 768, y: 100, fontSize: 18, type: 'header' },
            { text: 'Genetic Factors', x: 768, y: 250, fontSize: 16, type: 'subheader' },
            { text: 'Community', x: 1200, y: 512, fontSize: 16, type: 'label' },
        ...
        influencePaths: [
            { startX: 384, startY: 350, endX: 768, endY: 600, color: 'rgba(255, 159, 64, 0.8)', width: 4 }, // Left
            { startX: 768, startY: 450, endX: 768, endY: 600, color: 'rgba(54, 162, 235, 0.8)', width: 4 }, // Center
            { startX: 1152, startY: 350, endX: 768, endY: 600, color: 'rgba(75, 192, 192, 0.8)', width: 4 }  // Right
        ],
        interactiveElements: {
            medication: {
