(function () {
    ...
    window.GreenhouseEnvironmentConfig = {
        ...
        labels: [
            { text: 'label_environmental_stress', x: 768, y: 160, fontSize: 52, type: 'header' }, // Moved down from 100
        ...
        icons: [
            ...
            },
            {
                ...
                x: 768,
                y: 30, // Moved up slightly (was 20, but 30 is safer if header is 160)
                scale: 4.0,
                label: 'legend_society',
                color: 'rgba(54, 162, 235, 0.8)'
            }
        ],
        influencePaths: [
            { startX: 150, startY: 350, endX: 768, endY: 600, color: 'rgba(255, 159, 64, 0.7)', width: 6, label: 'legend_family' },
            { startX: 768, startY: 30, endX: 768, endY: 600, color: 'rgba(54, 162, 235, 0.7)', width: 6, label: 'legend_society' }, // Match icon Y
