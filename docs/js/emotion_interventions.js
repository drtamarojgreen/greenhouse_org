...
(function () {
    ...
    const medicationTreatments = [
        ...
        { id: 68, name: 'Deep Brain Stimulation (DBS)', description: 'Highlighting electrode placement in the Subgenual Cingulate (Area 25).', regions: ['prefrontalCortex'], wellnessFocus: 'Modulation', conditionMapping: 'Severe Depression' },
        ...
        { id: 72, name: 'Side Effect "Blunting" System', description: 'Modeling reduced Nucleus Accumbens activity associated with emotional blunting.', regions: ['thalamus'], wellnessFocus: 'Preservation', conditionMapping: 'Anhedonia' },
