// [TypeScript Migration] Source migrated from dna_repair.js — behavior preserved.
...
(async function () {
    ...
    (window as any).GreenhouseDNARepair = G;
    ...
    (window as any).Greenhouse = window.Greenhouse || {};
